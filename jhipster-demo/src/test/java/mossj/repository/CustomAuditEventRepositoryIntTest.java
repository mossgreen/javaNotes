package mossj.repository;

import mossj.JhipsterdemoApp;
import mossj.config.Constants;
import mossj.config.audit.AuditEventConverter;
import mossj.domain.PersistentAuditEvent;
...
import static mossj.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
